      ...
      * next field only in "mb5698n.cbl" - needed for new layout?
           ...
           05  MB-1021-FIELDS REDEFINES MB-CLIENT-FIELDS.
               10  FILLER                          PIC X(148).
      ...
      *pocket 7 added after the fact so had to put here
           ...
           05  MB-0346-FIELDS REDEFINES MB-CLIENT-FIELDS.
               ...
               10 MB-0346-SAMPLE-GROUP.
                  ...
                  15 MB-0346-SAMPL-YE.
                    20 MB-0346-SAMPL-TI-HIST  PIC X.
                    20 MB-0346-SAMPL-TI-PMI   PIC X.
                    20 MB-0346-SAMPL-TI-MIP   PIC X.
                    20 FILLER                 PIC X(1).
               10 MB-0346-SUPPRESSED-SW       PIC X.
               10 MB-0346-BNKL-CLSD-REASON-CD PIC X(2).
               10 MB-0346-ACCESS-NBR          PIC X(12).
               10 MB-0346-AUDIT               PIC X.
               10 MB-FOR1-SALE-DATE-YR        PIC S9(3) comp-3.
               10 MB-FOR1-SALE-DATE-MO        PIC S9(2).
               10 MB-FOR1-SALE-DATE-DA        PIC S9(2).
               10 FILLER                      PIC X(87).
      ****someone cut client user fields to 160, very confused
           05  MB-0310-FIELDS REDEFINES MB-CLIENT-FIELDS.
               10  MB-REC-NO                  PIC 9(3).
               10  MB-REC-NO-R REDEFINES MB-REC-NO PIC X(3).
               10  MB-IMAGE-OUT               PIC X(18).
               10  MB-FACE-IMAGE-OUT          PIC X(18).
               10  MB-FACE-IMAGE-OUT-2        PIC X(18).
      *********10  MB-HUD-LOAN-GONE           PIC X(15).
               10  MB-ACCELERATED-AMOUNT      PIC S9(9)V99 comp-3.
               10  MB-ACCELERATED-REASON-CODE PIC X(2).
               10  FILLER                     PIC X(7).
               10  MB-REC-NO-ORIGINAL         PIC X(3).
               10  MB-CORP-ADV-DATE           PIC X(8).
               10  MB-DUP-ONCERT1             PIC X(18).
               10  MB-DUP-ONCERT2             PIC X(18).
               10  MB-DUP-ONCERT3             PIC X(18).
               10  MB-DUP-ONCERT4             PIC X(18).
               10  FILLER                     PIC X(5).
           ...
           05  MB-0628-FIELDS REDEFINES MB-CLIENT-FIELDS.
               10 FILLER                      PIC X.
               10 MB-TI-TOTAL-DED-MI-0628     PIC S9(7)V99 COMP-3.
               10 MB-0628-BK                  PIC X(2).
               10 MB-0628-OPTION-ARM          PIC X(1).
               10 MB-0628-SAMPLE-VALUE        PIC X(10).
               10 MB-0628-ATTY-SW             PIC X(1).
               10 FILLER                      PIC X(139).
               10 MB-0628-ADDITIONAL-PAGE     PIC X(1).
      ...
      *        10  MB-5020-WEB-SITE           PIC X(30).
           ...
           05  MB-MBFIVAR2-FIELDS REDEFINES MB-CLIENT-FIELDS.
               ...
               10 FILLER                      PIC X(122).
           05  MB-BORR-EMAIL-ADDR             PIC X(66).
           05  MB-BORR-DUE-DATE               PIC X(10).
           05  MB-BORR-PMT-DUE                PIC 9(9).99.
           05  MB-BORR-PMT-DUEX REDEFINES MB-BORR-PMT-DUE PIC X(12).
           05  MB-E-CONSENT                   PIC X.
           05  MB-DRAFT-IND                   PIC X.
           ...
           05  MB-TI-DATA.
               ...
               15  MB-TI-LOAN-YY-R REDEFINES MB-TI-LOAN-YY PIC 9(4).
      ...
      ***  05  FILLER                         PIC X(83).
           ...
           05  MB-CO-BORR-EMAIL-ADDR REDEFINES
               MB-REMITTANCE-IMB-CODE         PIC X(65).
